    ...
    <section className="relative min-h-[92vh] flex items-center bg-slate-50 dark:bg-dark-900 overflow-hidden pt-24 pb-20">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 items-center">
          ...
          {/* Left Text Content */}
          <div className="lg:col-span-6 flex flex-col justify-center items-start lg:pr-6 order-2 lg:order-1 mt-2 lg:mt-0">
            
            <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/70 dark:bg-dark-800/70 backdrop-blur-xl border border-slate-200/60 dark:border-white/10 mb-6 lg:mb-8 shadow-sm order-1">
            ...
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-6 lg:mb-6 leading-[1.1] order-2">
            ...
            <p className="text-base sm:text-xl text-slate-600 dark:text-slate-300 mb-8 lg:mb-10 max-w-xl leading-relaxed font-light order-4 lg:order-3">
              {hero.subtext}
            </p>
            
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto order-3 lg:order-4 mb-8 lg:mb-0">
            ...
            <div className="mt-4 lg:mt-12 flex items-center justify-center sm:justify-start gap-6 text-sm font-medium text-slate-500 dark:text-slate-400 order-5 w-full sm:w-auto">
          ...
          {/* Right Image Content */}
          <div className="lg:col-span-6 relative px-4 sm:px-0 order-1 lg:order-2 w-full max-w-[90vw] sm:max-w-none mx-auto">
            ...
            {hero.floatingCards[0] && (
              <div className="hidden md:block absolute -left-2 sm:-left-10 lg:-left-16 top-16 sm:top-24 bg-white/10 dark:bg-dark-900/40 backdrop-blur-xl px-5 py-4 rounded-2xl shadow-2xl border border-white/40 dark:border-white/10 animate-float z-20">
            ...
            {hero.floatingCards[1] && (
              <div className="hidden md:block absolute -right-2 sm:-right-8 lg:-right-12 bottom-24 sm:bottom-32 bg-white/10 dark:bg-dark-900/40 backdrop-blur-xl px-5 py-4 rounded-2xl shadow-2xl border border-white/40 dark:border-white/10 animate-float animation-delay-2000 z-20">
                <div className="flex items-center gap-4">
            ...
            {hero.floatingCards[2] && (
              <div className="hidden md:block absolute left-1/2 -translate-x-1/2 -bottom-6 sm:-bottom-8 bg-white dark:bg-dark-800 backdrop-blur-xl px-6 py-3.5 rounded-full shadow-xl shadow-slate-900/10 dark:shadow-black/30 border border-slate-200 dark:border-white/10 animate-float animation-delay-4000 z-20">
