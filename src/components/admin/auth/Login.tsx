    ...
    <div className="min-h-screen bg-slate-50 dark:bg-dark-900 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md bg-white dark:bg-dark-800 rounded-3xl border border-slate-200 dark:border-white/5 shadow-sm overflow-hidden">
        ...
        <div className="p-8 pb-6 border-b border-slate-100 dark:border-white/5 bg-slate-50/50 dark:bg-dark-900/30 text-center">
          ...
          <p className="text-sm text-slate-500 mt-1">Secure sign in with your Google account</p>
        </div>

        <div className="p-8 space-y-6 text-center">
          <div className="mx-auto w-16 h-16 bg-blue-50 dark:bg-blue-500/10 text-blue-500 rounded-full flex items-center justify-center mb-4">
            <Lock size={32} />
          </div>
          
          <button
            onClick={() => signIn('google')}
            className="w-full flex items-center justify-center gap-3 bg-white dark:bg-dark-700 text-slate-700 dark:text-white border border-slate-200 dark:border-slate-600 font-medium py-3.5 rounded-xl transition-all shadow-sm hover:bg-slate-50 dark:hover:bg-dark-600"
          >
